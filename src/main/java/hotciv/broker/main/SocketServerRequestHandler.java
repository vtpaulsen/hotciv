...
public class SocketServerRequestHandler
    ...
    @Override
    public void setPortAndInvoker(int port, frds.broker.Invoker invoker) {

    }

    @Override
    public void setPortAndInvoker(int port, frds.broker.Invoker invoker, boolean useTLS) {
        ServerRequestHandler.super.setPortAndInvoker(port, invoker, useTLS);
    }
